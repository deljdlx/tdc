...
<style>
    ...
    .frame {
        ...
        border-image: linear-gradient(135deg, 
            ...
            #f4e4b8 85%,
            #d4af37 100%) 1;
        transition: border-color 0.25s, box-shadow 0.25s, transform 0.25s, filter 0.25s;
        cursor: default;
        box-shadow:
    ...
    .frame::after {
        ...
        background:
            repeating-linear-gradient(135deg, rgba(255, 255, 255, 0.03) 0 2px, rgba(0, 0, 0, 0.01) 2px 4px);
        pointer-events: none;
        z-index: 1;
    }
